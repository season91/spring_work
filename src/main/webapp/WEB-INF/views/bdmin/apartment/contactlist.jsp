      ...
      <div class="content">
          ...
          <div class="row d-flex card-body ">
	          <div class="col text-center">
	            <div class="block-27">
	              <ul>
	                <li><a href="/bdmin/${paging.type }/contactlist">&lt;&lt;</a></li>
	                <li><a href="/bdmin/${paging.type }/contactlist?page=${paging.prev}">&lt;</a></li>
	                <c:choose>
	                	<c:when test="${paging.lastPage eq 0 }">
	                		<li><a href="/bdmin/${paging.type }/contactlist">1</a></li>
	                	</c:when>
	                	<c:otherwise>
	                		<c:forEach begin="${paging.blockStart}" end="${paging.blockEnd}" var="page">
		                      <c:choose>
		                         <c:when test="${paging.currentPage eq page}">
		                            <li class="active"><a href="/bdmin/${paging.type }/contactlist?page=${page}">${page}</a></li>
		                         </c:when>
		                         <c:otherwise>
		                            <li><a href="/bdmin/${paging.type }/contactlist?page=${page}">${page}</a></li>
		                         </c:otherwise>
		                      </c:choose>
		                 	 </c:forEach> 
	                	</c:otherwise>
	                ...
	                <li><a href="/bdmin/${paging.type }/contactlist?page=${paging.next}">&gt;</a></li>
	                <li><a href="/bdmin/${paging.type }/contactlist?page=${paging.lastPage }">&gt;&gt;</a></li>
	              </ul>
	            </div>
	          </div>
	        </div>
